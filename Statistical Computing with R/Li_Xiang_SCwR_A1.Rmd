...
mybeerbottlefunction = function(num) {
  if ((num <= 0) | (length(num) > 1) | is.integer(num)) {
    stop('The input is not available!!!!')
  } else if (num == 1) {
    lyric = paste('1 bottle of beer on the wall, 1 bottle of beer. Take one ', 
                  'down, pass it around, no more bottles of beer on the wall.', 
                  sep = '')
    return(lyric)
  } else {
     lyric = paste(num, ' Bottles of Beers Song\n\n\n', sep = '')
  loop_v = rev(2:num)
  for (n in loop_v) {
    lyric = paste(lyric, n, ' bottles of beer on the wall, ', n, 
    ' bottles of beer. Take one down, pass it around, ', n-1, 
    ' bottles of beer on the wall...\n\n\n', sep = '')
  }
  lyric = paste(lyric, '1 bottle of beer on the wall, 1 bottle of beer. ', 
