...
plot(valid_df$longitude, valid_df$latitude, type = 'p', col = valid_df$color, ylim = c(min(valid_df$latitude), max(valid_df$latitude)+0.1), xlim = c(min(valid_df$longitude), max(valid_df$longitude)+0.1), ylab = 'latitude', xlab = 'longitude', main = 'Position Distribution of Airbnbs')
```

## 7
```{r, fig.height = 8, fig.width = 9, fig.align = "center"}
plot(valid_df$longitude, valid_df$latitude, type = 'p', col = valid_df$color, ylim = c(min(valid_df$latitude), max(valid_df$latitude)+0.1), xlim = c(min(valid_df$longitude), max(valid_df$longitude)+0.1), ylab = 'latitude', xlab = 'longitude', main = 'Position Distribution of Airbnbs', mar = c(5, 4, 6, 4))
legend(x = 'topright', legend = ave_price_df$neighbourhood_cleansed, pch = 'o', col = ave_price_df$color)
```
...
## 10
```{r, fig.height = 8, fig.width = 9, fig.align = "center"}
plot(valid_df$longitude, valid_df$latitude, type = 'p', col = valid_df$color, ylim = c(36.5, max(valid_df$latitude)+0.1), xlim = c(min(valid_df$longitude), max(valid_df$longitude)+0.1), ylab = 'latitude', xlab = 'longitude', main = 'Position Distribution of Airbnbs')
legend(x = 'topright', legend = ave_price_df$neighbourhood_cleansed, pch = 'o', col = ave_price_df$color)
points(x = 14.4346, y = 36.5532, pch = 17, col = 'black')
```
...
legend(x = 'topright', legend = ave_price_df$neighbourhood_cleansed, pch = 'o', col = ave_price_df$color)
points(x = 14.4346, y = 36.5532, pch = 17, col = 'black')
legend(x = 'bottomright', legend = 'Ragusa cathedral', pch = 17, col = 'black')
```
